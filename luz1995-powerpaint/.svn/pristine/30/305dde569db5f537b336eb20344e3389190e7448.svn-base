...
public class GUI {
    ...
    */
    private void setup() {
        ...
        final GUIMenuBar menuBar = new GUIMenuBar(guiFrame, panel);

        final Action[] actions = {new LineAction(panel), 
                                     new PencilAction(panel), new RectangleAction(panel), 
                                     new RRectangleAction(panel), new EllipseAction(panel)};
        ...
        final ImageIcon img = 
                        new ImageIcon(this.getClass().getResource("/resources/pubg.jpg"));
